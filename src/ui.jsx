      ...
      {panelOpen && (
        ...
        >
          <div className="panel-inner" style={{ padding: 16 }}>
            ...
            <div className="note">
              Tip: add <code>writeup.html</code> or <code>README.md</code> next to <code>index.html</code>.
            </div>
          </div>
        </aside>
      )}
    ...
    <div className="welcome-wrap">
      <section className="welcome-hero">
        ...
        <div className="welcome-hero__content">
          ...
          <p className="welcome-sub">A tidy, mobile-friendly template for presenting hands-on tools and experiments.</p>
...
function AppShell() {
  ...
  // theme (class-based + data-theme for compatibility)
  ...
  return (
    <>
      ...
      {/* Mobile FAB to open drawer (bottom-right, visible above content) */}
      {isMobile && !drawerOpen && (
        <button
