import { AppState, ExportSize, ExportKind } from "./types"; import { previewDimsPx } from "./layout"; import { Result, ok, err } from "./result";
...
a.href = url;
a.download =
  "comic-panel-" + kind + "-" + state.dpi + "dpi.svg";
a.click();
