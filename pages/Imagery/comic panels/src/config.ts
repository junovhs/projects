import { UnitKey, UnitDef, PresetKey, PresetDef } from "./types";
...
"comic-standard": { wIn: 6.875, hIn: 10.4375, name: 'Comic Standard (6.875" x 10.4375")' },
...
square: { wIn: 8.333, hIn: 8.333, name: "Square (800 x 800 at 96DPI approx.)" },
